...
game.onUpdateInterval(5000, function () {
    happyCloud = sprites.create(assets.image`happyCloud`, SpriteKind.Projectile)
    happyCloud.setPosition(148, 25)
    happyCloud.setVelocity(-6, -1)
})
